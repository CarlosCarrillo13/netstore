...
@RestController
@RequestMapping("/api/netstore-kafka")
public class NetstoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(NetstoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NetstoreKafkaResource(KafkaProperties kafkaProperties) {
