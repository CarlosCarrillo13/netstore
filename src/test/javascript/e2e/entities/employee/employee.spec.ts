...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    ...
    expect(await employeeComponentsPage.getTitle()).to.eq('netstoreApp.employee.home.title');
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('netstoreApp.employee.home.createOrEditLabel');
  ...
  it('should create and save Employees', async () => {
    ...
    await promise.all([
      ...
      employeeUpdatePage.pointOfSaleSelectLastOption(),
      employeeUpdatePage.employeeSelectLastOption(),
    ]);
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('netstoreApp.employee.delete.question');
