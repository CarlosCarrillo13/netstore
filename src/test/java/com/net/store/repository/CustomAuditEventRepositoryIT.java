...
import com.net.store.config.audit.AuditEventConverter;
import com.net.store.domain.PersistentAuditEvent;
...
import static com.net.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
