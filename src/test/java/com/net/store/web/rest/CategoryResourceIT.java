...
import com.net.store.repository.CategoryRepository;
import com.net.store.repository.search.CategorySearchRepository;
...
public class CategoryResourceIT {
     ...
     *
     * @see com.net.store.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
