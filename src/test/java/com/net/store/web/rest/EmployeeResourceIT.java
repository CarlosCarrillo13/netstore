...
import com.net.store.repository.EmployeeRepository;
import com.net.store.repository.search.EmployeeSearchRepository;
...
public class EmployeeResourceIT {
     ...
     *
     * @see com.net.store.repository.search.EmployeeSearchRepositoryMockConfiguration
     */
    @Autowired
