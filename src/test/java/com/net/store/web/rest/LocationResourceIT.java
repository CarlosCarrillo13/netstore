...
import com.net.store.repository.LocationRepository;
import com.net.store.repository.search.LocationSearchRepository;
...
public class LocationResourceIT {
     ...
     *
     * @see com.net.store.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
