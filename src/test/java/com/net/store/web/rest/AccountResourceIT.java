...
import com.net.store.config.Constants;
import com.net.store.domain.User;
import com.net.store.repository.AuthorityRepository;
import com.net.store.repository.UserRepository;
import com.net.store.security.AuthoritiesConstants;
import com.net.store.service.UserService;
import com.net.store.service.dto.PasswordChangeDTO;
import com.net.store.service.dto.UserDTO;
import com.net.store.web.rest.vm.KeyAndPasswordVM;
...
import static com.net.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
public class AccountResourceIT {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SALES));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SALES));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SALES));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.SALES).get());
    }
